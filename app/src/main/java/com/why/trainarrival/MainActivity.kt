        ...
        if(timeGetter.trains.size>0){
                if (timeGetter.trains[0].first > LastTrainTime && (timeGetter.trains[0].first-LastTrainTime)>1) {
                    ...
                    t.post {
                        ...
                        t.text = "eastbound departing"
                    }
                }
                else {
                    t.post {
                        t.text = "eastbound wait " + timeGetter.trains[0].first
                    }
                }
            ...
            if (timeGetter.trains.size>1){
                ...
                if (timeGetter.trains[1].first > LastTrainTime2 && (timeGetter.trains[1].first-LastTrainTime2)>1) {
                    mp2.start()
                    t.post {
                    ...
                    t.post {
                        t.text = "westbound wait " + timeGetter.trains[1].first
                    }
                }
